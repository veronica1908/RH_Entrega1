  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/veronica1908/RH_Entrega1/blob/main/funciones.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "source": [
        ...
        "\n",
        "#función que muestra categorías\n",
        ...
        "  return df\n",
        "\n",
        "#Función que ejecuta sql en python\n",
        ...
        "\n",
        "#función para comparar los desempeños de modelos\n",
